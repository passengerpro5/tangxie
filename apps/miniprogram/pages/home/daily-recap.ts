...
export interface DailyRecapScorecardModel {
  title: string;
  tagline: string;
...
export interface DailyRecapScorecardInput {
  title: string;
  metrics: DailyRecapMetric[];
  summary: string;
}

function formatMetric(metric: DailyRecapMetric) {
...
export function createDailyRecapScorecardModel(input: DailyRecapScorecardInput): DailyRecapScorecardModel {
