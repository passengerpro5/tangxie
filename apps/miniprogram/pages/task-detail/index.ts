...
export interface TaskDetailMetaModel {
...
export interface TaskDetailSectionItem {
  id: string;
  label: string;
  value: string;
}

export interface TaskDetailSectionModel {
  id: string;
  title: string;
  summary?: string;
  items: TaskDetailSectionItem[];
}
...
export interface TaskDetailModel {
  ...
  priorityLabel: string;
  sourceLabel: string;
  meta: TaskDetailMetaModel;
  sections: TaskDetailSectionModel[];
...
export function createTaskDetailPage(task: {
  ...
  const sections: TaskDetailSectionModel[] = [
    {
      id: "overview",
      title: "任务概览",
      summary: content,
